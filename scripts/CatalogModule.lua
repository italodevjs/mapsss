...
function CatalogModule.CreateCard(data, parent)
	...
	card.Size = UDim2.new(0, 150, 0, 220)
	...
	-- Nome
	local nameTop = data.IsSpecial and 150 or 126
	...
	-- Preço
	local priceTop = data.IsSpecial and 180 or 156
	...
	-- Botões
	local btnTop = data.IsSpecial and 200 or 176
